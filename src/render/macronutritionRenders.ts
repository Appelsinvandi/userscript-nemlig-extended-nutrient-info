...
export function renderMacronutrients() {
  ...
  if (itemEnergy == null || itemCarbohydrate == null || itemFat == null || itemProtein == null) return null

  const totalMacronutrientEnergy =
    itemCarbohydrate * MacronutrientEnergyDensity.CARBOHYDRATE + itemProtein * MacronutrientEnergyDensity.PROTEIN + itemFat * MacronutrientEnergyDensity.FAT
...
`
  ...
  function generateMacroStatHTML(name: string, macro: ReturnType<typeof calculateMacro>, color: string) {
